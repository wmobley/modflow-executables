#!/usr/bin/env python3
"""Resolve or generate a MODFLOW-USG name file from staged inputs."""
...
PACKAGE_CONFIG = {
    ...
    "gnc": {"tokens": ("GNC",), "path_keys": ("model.gnc", ".gnc"), "fallback_unit": "70"},
    "hfb": {"tokens": ("HFB6", "HFB"), "path_keys": ("model.hfb", ".hfb"), "fallback_unit": "29"},
    "lpf": {"tokens": ("LPF",), "path_keys": ("model.lpf", ".lpf"), "fallback_unit": "15"},
    "oc": {"tokens": ("OC",), "path_keys": ("model.oc", ".oc"), "fallback_unit": "14"},
    "rch": {"tokens": ("RCH",), "path_keys": ("model.rch", ".rch"), "fallback_unit": "19"},
    "riv": {"tokens": ("RIV",), "path_keys": ("model.riv", ".riv"), "fallback_unit": "18"},
    "sms": {"tokens": ("SMS",), "path_keys": ("model.sms", ".sms"), "fallback_unit": "32"},
...
def resolve_nam_path(run_root: Path) -> Path:
    ...
    raise SystemExit("Unable to locate or generate a MODFLOW-USG name file.")
